...
parser.add_argument('--label_name', type=str, choices = ['arousal', 'valence'])
parser.add_argument('--store_name', type=str, default="")
parser.add_argument('--save_root', type=str, default="")
# ========================= Model Configs ==========================
parser.add_argument('--cnn', type=str, default = 'resnet50', choices = ['resnet50'])
parser.add_argument('--root_path', type=str, default =['../scripts/dir-to-aligned-face/tra/processed','../../Affwild2/cropped_aligned'])
parser.add_argument('--annot_dir', type=str, default =['./annotations','./set'])
